...
-- Vhdl Test Bench template for design  :  max10OnePortRam
--
...
ENTITY max10OnePortRam_tb IS
end max10OnePortRam_tb;
architecture max10OnePortRam_arch_tb OF max10OnePortRam_tb IS
-- constants
-- signals
...
begin
	...
	uut : entity work.max10OnePortRam
	PORT MAP (
...
end architecture max10OnePortRam_arch_tb;
