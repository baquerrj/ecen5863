...
//    uart_init();            // see src/uart_util.c
  ...
  while(1) {
    ...
    alt_printf("Press '5' to count up by five\n");
	...
	// Additional options to count up by 5 (5) and down by 10 (t)
    else if (input == '5') {
        dir = 5;
    	binary_count = 0;
    ...
    while(((binary_count < MAX_COUNT && dir > 0) || ( binary_count > 0 && dir == -1)) || (binary_count > 10 && dir == -10))
    {
