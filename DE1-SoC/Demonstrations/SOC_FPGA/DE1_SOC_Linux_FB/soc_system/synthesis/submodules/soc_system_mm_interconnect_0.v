...
// 
// Generated using ACDS version 13.1 162 at 2014.05.16.16:58:11
...
module soc_system_mm_interconnect_0 (
	...
	wire  [120:0] master_secure_master_translator_avalon_universal_master_0_agent_cp_data;                   // master_secure_master_translator_avalon_universal_master_0_agent:cp_data -> addr_router:sink_data
	...
	wire  [228:0] alt_vip_vfr_vga_avalon_master_translator_avalon_universal_master_0_agent_cp_data;          // alt_vip_vfr_vga_avalon_master_translator_avalon_universal_master_0_agent:cp_data -> addr_router_001:sink_data
	...
	wire  [120:0] limiter_rsp_src_data;                                                                      // limiter:rsp_src_data -> master_secure_master_translator_avalon_universal_master_0_agent:rp_data
	...
	wire  [228:0] limiter_001_rsp_src_data;                                                                  // limiter_001:rsp_src_data -> alt_vip_vfr_vga_avalon_master_translator_avalon_universal_master_0_agent:rp_data
	...
	wire  [120:0] limiter_cmd_src_data;                                                                      // limiter:cmd_src_data -> width_adapter:in_data
	wire    [1:0] limiter_cmd_src_channel;                                                                   // limiter:cmd_src_channel -> width_adapter:in_channel
	...
	wire  [228:0] width_adapter_src_data;                                                                    // width_adapter:out_data -> cmd_xbar_demux:sink_data
	...
	wire  [228:0] rsp_xbar_mux_src_data;                                                                     // rsp_xbar_mux:src_data -> width_adapter_001:in_data
	wire    [1:0] rsp_xbar_mux_src_channel;                                                                  // rsp_xbar_mux:src_channel -> width_adapter_001:in_channel
	...
	wire  [120:0] width_adapter_001_src_data;                                                                // width_adapter_001:out_data -> limiter:rsp_sink_data
	wire          width_adapter_001_src_ready;                                                               // limiter:rsp_sink_ready -> width_adapter_001:out_ready
	wire    [1:0] width_adapter_001_src_channel;                                                             // width_adapter_001:out_channel -> limiter:rsp_sink_channel
	...
	soc_system_mm_interconnect_0_addr_router_001 addr_router_001 (
	...
	soc_system_mm_interconnect_0_cmd_xbar_demux_001 cmd_xbar_demux_001 (
		.clk                (clk_0_clk_clk),                                                  //        clk.clk
		.reset              (alt_vip_vfr_vga_clock_master_reset_reset_bridge_in_reset_reset), //  clk_reset.reset
	...
	soc_system_mm_interconnect_0_cmd_xbar_demux rsp_xbar_demux (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_system_mm_interconnect_0_cmd_xbar_demux rsp_xbar_demux_001 (
		.clk                (clk_0_clk_clk),                                                    //       clk.clk
		.reset              (hps_0_f2h_axi_slave_agent_reset_sink_reset_bridge_in_reset_reset), // clk_reset.reset
